...
namespace FashionNest.Application.Features.Orders.Queries.GetOrders
{
    public class GetOrdersQueryHandler : IQueryHandler<GetOrdersQuery, GetOrdersResult>
    {
        ...
        private readonly ICouponRepository couponRepository; // Thêm repository cho Coupon

        public GetOrdersQueryHandler(IOrderRepository orderRepository, ICouponRepository couponRepository)
        {
            this.orderRepository = orderRepository;
            this.couponRepository = couponRepository; // Khởi tạo couponRepository
        }
