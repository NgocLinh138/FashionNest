...
namespace FashionNest.Infrastructure.Migrations
{
    ...
    [Migration("20241107170635_UpdateCouponTable")]
            ...
            modelBuilder.Entity("FashionNest.Domain.Entities.Coupon", b =>
                {
                    ...
                    b.Property<bool>("IsNewCustomerOnly")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FashionNest.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 11, 8, 0, 6, 34, 469, DateTimeKind.Local).AddTicks(1572));
